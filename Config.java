...
public class Config {
    ...
    public static final Color COLOR_BG = new Color(147, 218, 73);
    ...
    public static final Color COLOR_OVNI = Color.BLUE;
    public static final Color COLOR_OVNI2 = Color.ORANGE;
